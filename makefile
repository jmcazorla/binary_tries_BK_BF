...
program: $(OBJDIR)/intersection_query_log.o \
		 $(OBJDIR)/intersection_query_high_btrie_log.o \
         $(OBJDIR)/barbay_kenyon_log.o \
         $(OBJDIR)/report_high_btrie_log.o \
	...
	$(CC) -o $(BUILDIR)/report_high_btrie.out $(OBJDIR)/report_high_btrie_log.o  $(CFLAGS) $(SDSLFLAGS)
	...
	$(CC) -o $(BUILDIR)/queries_high_btrie.out $(OBJDIR)/intersection_query_high_btrie_log.o  $(CFLAGS) $(SDSLFLAGS) -pthread 
...
$(OBJDIR)/report_high_btrie_log.o: test/report_high_btrie_log.cpp
	mkdir -p obj
	$(CC) -c -o $@ test/report_high_btrie_log.cpp $(CFLAGS)  $(SDSLFLAGS)
...
$(OBJDIR)/intersection_query_high_btrie_log.o: test/intersection_query_high_btrie_log.cpp
	mkdir -p obj
	$(CC) -c -o $@ test/intersection_query_high_btrie_log.cpp $(CFLAGS) $(SDSLFLAGS)
